...
export const MsgCreateAllianceProposal = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgCreateAllianceProposal>, I>>(object: I): MsgCreateAllianceProposal {
    const message = createBaseMsgCreateAllianceProposal();
...
export const MsgUpdateAllianceProposal = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdateAllianceProposal>, I>>(object: I): MsgUpdateAllianceProposal {
    const message = createBaseMsgUpdateAllianceProposal();
    message.title = object.title ?? "";
    message.description = object.description ?? "";
    message.denom = object.denom ?? "";
...
export const MsgDeleteAllianceProposal = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgDeleteAllianceProposal>, I>>(object: I): MsgDeleteAllianceProposal {
    const message = createBaseMsgDeleteAllianceProposal();
    message.title = object.title ?? "";
    message.description = object.description ?? "";
    message.denom = object.denom ?? "";
