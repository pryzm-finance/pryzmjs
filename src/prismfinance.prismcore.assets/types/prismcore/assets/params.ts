...
import { FeeRatios } from "./refractable_asset";
...
function createBaseParams(): Params {
  return { defaultFeeRatios: undefined };
}
...
export const Params = {
  ...
  toJSON(message: Params): unknown {
    const obj: any = {};
    message.defaultFeeRatios !== undefined
      && (obj.defaultFeeRatios = message.defaultFeeRatios ? FeeRatios.toJSON(message.defaultFeeRatios) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    const message = createBaseParams();
    message.defaultFeeRatios = (object.defaultFeeRatios !== undefined && object.defaultFeeRatios !== null)
      ? FeeRatios.fromPartial(object.defaultFeeRatios)
      : undefined;
    return message;
  },
};
