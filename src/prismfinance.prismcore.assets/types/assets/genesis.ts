...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.whitelistedAssetList.push(
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (
      object.whitelistedAssetList !== undefined &&
      object.whitelistedAssetList !== null
    ) {
      for (const e of object.whitelistedAssetList) {
        message.whitelistedAssetList.push(WhitelistedAsset.fromJSON(e));
      }
    }
    return message;
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.whitelistedAssetList) {
      obj.whitelistedAssetList = message.whitelistedAssetList.map((e) =>
  ...
  fromPartial(object: DeepPartial<GenesisState>): GenesisState {
    ...
    if (
      ...
      for (const e of object.whitelistedAssetList) {
        message.whitelistedAssetList.push(WhitelistedAsset.fromPartial(e));
      }
    }
    return message;
  },
