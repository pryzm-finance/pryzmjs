...
function createBaseOraclePreVote(): OraclePreVote {
  return { validator: "", hash: "", submitBlock: 0 };
}

export const OraclePreVote = {
  encode(message: OraclePreVote, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): OraclePreVote {
  ...
  fromPartial<I extends Exact<DeepPartial<OraclePreVote>, I>>(object: I): OraclePreVote {
    const message = createBaseOraclePreVote();
