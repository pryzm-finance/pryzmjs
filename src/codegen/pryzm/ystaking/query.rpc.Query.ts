...
export class QueryClientImpl implements Query {
  ...
  userStakeStateAll(request: DeepPartial<QueryAllUserStakeStateRequest> = {
    pagination: undefined
  }, metadata?: grpc.Metadata): Promise<QueryAllUserStakeStateResponse> {
...
export const QueryDesc = {
  serviceName: "pryzm.ystaking.Query"
};
