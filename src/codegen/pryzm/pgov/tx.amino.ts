...
export interface MsgUpdateParamsAminoType extends AminoMsg {
  type: "/pryzm.pgov.MsgUpdateParams";
  value: {
    authority: string;
    params: {
      min_deposit: {
...
export interface MsgStakePAssetsAminoType extends AminoMsg {
  type: "/pryzm.pgov.MsgStakePAssets";
  value: {
    creator: string;
    amount: {
      denom: string;
...
export interface MsgUnstakePAssetsAminoType extends AminoMsg {
  type: "/pryzm.pgov.MsgUnstakePAssets";
  value: {
    creator: string;
    amount: {
      denom: string;
...
export interface MsgSubmitProposalAminoType extends AminoMsg {
  type: "/pryzm.pgov.MsgSubmitProposal";
  value: {
    creator: string;
    asset: string;
    proposal: Uint8Array;
...
export interface MsgRetryVoteTransmitAminoType extends AminoMsg {
  type: "/pryzm.pgov.MsgRetryVoteTransmit";
  value: {
    creator: string;
    asset: string;
    proposal: string;
...
export const AminoConverter = {
  "/pryzm.pgov.MsgUpdateParams": {
    aminoType: "/pryzm.pgov.MsgUpdateParams",
    toAmino: ({
      authority,
      params
  ...
  "/pryzm.pgov.MsgStakePAssets": {
    aminoType: "/pryzm.pgov.MsgStakePAssets",
    toAmino: ({
      creator,
      amount
  ...
  "/pryzm.pgov.MsgUnstakePAssets": {
    aminoType: "/pryzm.pgov.MsgUnstakePAssets",
    toAmino: ({
      creator,
      amount
  ...
  "/pryzm.pgov.MsgSubmitVote": {
    aminoType: "/pryzm.pgov.MsgSubmitVote",
    toAmino: ({
      voter,
      asset,
      proposal,
  ...
  "/pryzm.pgov.MsgSubmitProposal": {
    aminoType: "/pryzm.pgov.MsgSubmitProposal",
    toAmino: ({
      creator,
      asset,
      proposal,
  ...
  "/pryzm.pgov.MsgRetryVoteTransmit": {
    aminoType: "/pryzm.pgov.MsgRetryVoteTransmit",
    toAmino: ({
      creator,
      asset,
      proposal
