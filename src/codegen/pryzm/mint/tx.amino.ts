...
export interface MsgUpdateParamsAminoType extends AminoMsg {
  type: "/pryzm.mint.MsgUpdateParams";
  value: {
    authority: string;
    params: {
      mint_denom: string;
...
export interface MsgDappAccountSpendAminoType extends AminoMsg {
  type: "/pryzm.mint.MsgDappAccountSpend";
  value: {
    authority: string;
    title: string;
    description: string;
...
export const AminoConverter = {
  "/pryzm.mint.MsgUpdateParams": {
    aminoType: "/pryzm.mint.MsgUpdateParams",
    toAmino: ({
      authority,
      params
  ...
  "/pryzm.mint.MsgDappAccountSpend": {
    aminoType: "/pryzm.mint.MsgDappAccountSpend",
    toAmino: ({
      authority,
      title,
      description,
