...
export class LCDQueryClient {
  ...
  /* SimulateRecoveryExit */
  async simulateRecoveryExit(params: QuerySimulateRecoveryExitRequest): Promise<QuerySimulateRecoveryExitResponseSDKType> {
    const options: any = {
      params: {}
    };
    if (typeof params?.poolId !== "undefined") {
    ...
    const endpoint = `pryzm/amm/v1/simulate_recovery_exit`;
    return await this.req.get<QuerySimulateRecoveryExitResponseSDKType>(endpoint, options);
  }
