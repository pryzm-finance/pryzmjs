...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    prismfinance: {
      prismcore: {
        amm: (await import("../prismcore/amm/query.rpc.Query")).createRpcQueryExtension(client),
        ...
        treasury: (await import("../prismcore/treasury/query.rpc.Query")).createRpcQueryExtension(client),
        ystaking: (await import("../prismcore/ystaking/query.rpc.Query")).createRpcQueryExtension(client)
      }
    }
  };
};