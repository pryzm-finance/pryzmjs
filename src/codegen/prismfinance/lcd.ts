...
export const createLCDClient = async ({
  ...
  return {
    ...
    prismfinance: {
      prismcore: {
        amm: new (await import("../prismcore/amm/query.lcd")).LCDQueryClient({
          requestClient
        }),
        assets: new (await import("../prismcore/assets/query.lcd")).LCDQueryClient({
          requestClient
        }),
        icq: new (await import("../prismcore/icq/query.lcd")).LCDQueryClient({
          requestClient
        }),
        ...
        pgov: new (await import("../prismcore/pgov/query.lcd")).LCDQueryClient({
          requestClient
        }),
        refractor: new (await import("../prismcore/refractor/query.lcd")).LCDQueryClient({
          requestClient
        }),
        treasury: new (await import("../prismcore/treasury/query.lcd")).LCDQueryClient({
          requestClient
        }),
        ystaking: new (await import("../prismcore/ystaking/query.lcd")).LCDQueryClient({
          requestClient
        })
      }
    }
