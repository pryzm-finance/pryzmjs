...
import * as _150 from "./lightclients/localhost/v2/localhost";
...
import * as _350 from "./applications/interchain_accounts/controller/v1/tx.amino";
import * as _351 from "./applications/interchain_accounts/host/v1/tx.amino";
import * as _352 from "./applications/transfer/v1/tx.amino";
import * as _353 from "./core/channel/v1/tx.amino";
import * as _354 from "./core/client/v1/tx.amino";
import * as _355 from "./core/connection/v1/tx.amino";
import * as _356 from "./applications/interchain_accounts/controller/v1/tx.registry";
import * as _357 from "./applications/interchain_accounts/host/v1/tx.registry";
import * as _358 from "./applications/transfer/v1/tx.registry";
import * as _359 from "./core/channel/v1/tx.registry";
import * as _360 from "./core/client/v1/tx.registry";
import * as _361 from "./core/connection/v1/tx.registry";
import * as _362 from "./applications/interchain_accounts/controller/v1/query.lcd";
import * as _363 from "./applications/interchain_accounts/host/v1/query.lcd";
import * as _364 from "./applications/transfer/v1/query.lcd";
import * as _365 from "./core/channel/v1/query.lcd";
import * as _366 from "./core/client/v1/query.lcd";
import * as _367 from "./core/connection/v1/query.lcd";
import * as _368 from "./applications/interchain_accounts/controller/v1/query.rpc.Query";
import * as _369 from "./applications/interchain_accounts/host/v1/query.rpc.Query";
import * as _370 from "./applications/transfer/v1/query.rpc.Query";
import * as _371 from "./core/channel/v1/query.rpc.Query";
import * as _372 from "./core/client/v1/query.rpc.Query";
import * as _373 from "./core/connection/v1/query.rpc.Query";
