...
export const createGrpcWebClient = async ({
  ...
  return {
    ...
    ibc: {
      applications: {
        fee: {
          v1: new (await import("./applications/fee/v1/query.rpc.Query")).QueryClientImpl(grpcWeb)
        },
        interchain_accounts: {
          controller: {
            v1: new (await import("./applications/interchain_accounts/controller/v1/query.rpc.Query")).QueryClientImpl(grpcWeb)
          },
          host: {
            v1: new (await import("./applications/interchain_accounts/host/v1/query.rpc.Query")).QueryClientImpl(grpcWeb)
          }
        },
        transfer: {
