...
export const createRPCMsgClient = async ({
  ...
  return {
    ...
    ibc: {
      applications: {
        fee: {
          v1: new (await import("./applications/fee/v1/tx.rpc.msg")).MsgClientImpl(grpcWeb)
        },
        interchain_accounts: {
          controller: {
            v1: new (await import("./applications/interchain_accounts/controller/v1/tx.rpc.msg")).MsgClientImpl(grpcWeb)
          }
        },
        transfer: {
