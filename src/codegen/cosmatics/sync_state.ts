...
export const SyncState = {
  ...
  toAmino(message: SyncState): SyncStateAmino {
    const obj: any = {};
  ...
  fromProtoMsg(message: SyncStateProtoMsg): SyncState {
    return SyncState.decode(message.value);
  },
...
export const QuerySyncStateRequest = {
  ...
  toAmino(_: QuerySyncStateRequest): QuerySyncStateRequestAmino {
    const obj: any = {};
    return obj;
  },
  ...
  fromProtoMsg(message: QuerySyncStateRequestProtoMsg): QuerySyncStateRequest {
    return QuerySyncStateRequest.decode(message.value);
  },
...
export const QuerySyncStateResponse = {
  ...
  toAmino(message: QuerySyncStateResponse): QuerySyncStateResponseAmino {
    const obj: any = {};
    obj.sync_state = message.syncState ? SyncState.toAmino(message.syncState) : undefined;
    return obj;
  },
  ...
  fromProtoMsg(message: QuerySyncStateResponseProtoMsg): QuerySyncStateResponse {
    return QuerySyncStateResponse.decode(message.value);
  },
