...
export interface MsgRedeemAminoType extends AminoMsg {
  type: "/prism.refractor.MsgRedeem";
  value: {
    creator: string;
    p_amount: {
      denom: string;
...
export const AminoConverter = {
  "/prism.refractor.MsgRefract": {
    aminoType: "/prism.refractor.MsgRefract",
    toAmino: ({
      creator,
      amount,
      maturity
  ...
  "/prism.refractor.MsgRedeem": {
    aminoType: "/prism.refractor.MsgRedeem",
    toAmino: ({
      creator,
      pAmount,
      yAmount
