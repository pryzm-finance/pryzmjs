...
export interface MsgDappAccountSpendAminoType extends AminoMsg {
  type: "/prism.mint.MsgDappAccountSpend";
  value: {
    authority: string;
    title: string;
    description: string;
...
export const AminoConverter = {
  "/prism.mint.MsgUpdateParams": {
    aminoType: "/prism.mint.MsgUpdateParams",
    toAmino: ({
      authority,
      params
  ...
  "/prism.mint.MsgDappAccountSpend": {
    aminoType: "/prism.mint.MsgDappAccountSpend",
    toAmino: ({
      authority,
      title,
      description,
