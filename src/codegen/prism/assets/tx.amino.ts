...
export interface MsgDisableAssetAminoType extends AminoMsg {
  type: "/prism.assets.MsgDisableAsset";
  value: {
    authority: string;
    asset_id: string;
  };
...
export interface MsgUpdateMaturityParamsAminoType extends AminoMsg {
  type: "/prism.assets.MsgUpdateMaturityParams";
  value: {
    authority: string;
    asset_id: string;
    params: {
...
export interface MsgUpdateFeeRatiosAminoType extends AminoMsg {
  type: "/prism.assets.MsgUpdateFeeRatios";
  value: {
    authority: string;
    asset_id: string;
    fee_ratios: {
...
export const AminoConverter = {
  ...
  "/prism.assets.MsgDisableAsset": {
    aminoType: "/prism.assets.MsgDisableAsset",
    toAmino: ({
      authority,
      assetId
  ...
  "/prism.assets.MsgUpdateMaturityParams": {
    aminoType: "/prism.assets.MsgUpdateMaturityParams",
    toAmino: ({
      authority,
      assetId,
      params
  ...
  "/prism.assets.MsgUpdateFeeRatios": {
    aminoType: "/prism.assets.MsgUpdateFeeRatios",
    toAmino: ({
      authority,
      assetId,
      feeRatios
