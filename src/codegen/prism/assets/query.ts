...
export interface QueryGetExchangeRateResponseSDKType {
  exchange_rate?: ExchangeRateSDKType;
}
export interface QueryAllExchangeRateRequest {
  pagination?: PageRequest;
}
export interface QueryAllExchangeRateRequestSDKType {
  pagination?: PageRequestSDKType;
}
...
export interface QueryAllExchangeRateResponseSDKType {
  exchange_rate: ExchangeRateSDKType[];
  pagination?: PageResponseSDKType;
}
...
export const QueryGetExchangeRateRequest = {
  ...
  fromPartial(object: Partial<QueryGetExchangeRateRequest>): QueryGetExchangeRateRequest {
    const message = createBaseQueryGetExchangeRateRequest();
    message.assetId = object.assetId ?? "";
    return message;
  }
...
export const QueryGetExchangeRateResponse = {
  ...
  fromPartial(object: Partial<QueryGetExchangeRateResponse>): QueryGetExchangeRateResponse {
    const message = createBaseQueryGetExchangeRateResponse();
...
export const QueryAllExchangeRateRequest = {
  ...
  fromPartial(object: Partial<QueryAllExchangeRateRequest>): QueryAllExchangeRateRequest {
    const message = createBaseQueryAllExchangeRateRequest();
    message.pagination = object.pagination !== undefined && object.pagination !== null ? PageRequest.fromPartial(object.pagination) : undefined;
    return message;
  }
...
export const QueryAllExchangeRateResponse = {
  ...
  fromJSON(object: any): QueryAllExchangeRateResponse {
    return {
      exchangeRate: Array.isArray(object?.exchangeRate) ? object.exchangeRate.map((e: any) => ExchangeRate.fromJSON(e)) : [],
      pagination: isSet(object.pagination) ? PageResponse.fromJSON(object.pagination) : undefined
    };
  },
  ...
  fromPartial(object: Partial<QueryAllExchangeRateResponse>): QueryAllExchangeRateResponse {
    const message = createBaseQueryAllExchangeRateResponse();
