...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    prism: {
      ...
      icstaking: (await import("./icstaking/query.rpc.Query")).createRpcQueryExtension(client),
      ...
      pgov: (await import("./pgov/query.rpc.Query")).createRpcQueryExtension(client),
      refractor: (await import("./refractor/query.rpc.Query")).createRpcQueryExtension(client),
      treasury: (await import("./treasury/query.rpc.Query")).createRpcQueryExtension(client),
      ystaking: (await import("./ystaking/query.rpc.Query")).createRpcQueryExtension(client)
    }
  };
};