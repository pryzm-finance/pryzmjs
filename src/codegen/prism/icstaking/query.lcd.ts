...
export class LCDQueryClient {
  ...
  async params(_params: QueryParamsRequest = {}): Promise<QueryParamsResponseSDKType> {
    const endpoint = `prism-finance/prism-core/icstaking/params`;
  ...
  async hostChain(params: QueryGetHostChainRequest): Promise<QueryGetHostChainResponseSDKType> {
    const endpoint = `prism-finance/prism-core/icstaking/host_chain/${params.hostChainId}`;
  ...
  async hostChainAll(params: QueryAllHostChainRequest = {
    ...
    const endpoint = `prism-finance/prism-core/icstaking/host_chain`;
  ...
  async hostChainState(params: QueryGetHostChainStateRequest): Promise<QueryGetHostChainStateResponseSDKType> {
    const endpoint = `prism-finance/prism-core/icstaking/host_chain_state/${params.hostChainId}`;
  ...
  async hostChainStateAll(params: QueryAllHostChainStateRequest = {
    ...
    const endpoint = `prism-finance/prism-core/icstaking/host_chain_state`;
  ...
  async undelegation(params: QueryGetUndelegationRequest): Promise<QueryGetUndelegationResponseSDKType> {
    const endpoint = `prism-finance/prism-core/icstaking/undelegation/${params.hostChain}/${params.epoch}`;
  ...
  async undelegationAll(params: QueryAllUndelegationRequest = {
    ...
    const endpoint = `prism-finance/prism-core/icstaking/undelegation`;
  ...
  async incompleteUndelegationAll(params: QueryIncompleteUndelegationRequest): Promise<QueryIncompleteUndelegationResponseSDKType> {
    ...
    const endpoint = `prism-finance/prism-core/icstaking/undelegation/${params.hostChain}`;
