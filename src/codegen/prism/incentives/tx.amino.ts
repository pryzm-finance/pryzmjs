...
export interface MsgCreatePoolAminoType extends AminoMsg {
  type: "/prism.incentives.MsgCreatePool";
  value: {
    authority: string;
    bond_denom: string;
    reward_tokens: {
...
export interface MsgUpdateRewardTokenWeightAminoType extends AminoMsg {
  type: "/prism.incentives.MsgUpdateRewardTokenWeight";
  value: {
    authority: string;
    bond_denom: string;
    reward_token: {
...
export interface MsgAddRewardTokenToPoolAminoType extends AminoMsg {
  type: "/prism.incentives.MsgAddRewardTokenToPool";
  value: {
    authority: string;
    bond_denom: string;
    reward_token: {
...
export interface MsgUnbondAminoType extends AminoMsg {
  type: "/prism.incentives.MsgUnbond";
  value: {
    creator: string;
    amount: {
      denom: string;
...
export interface MsgClaimRewardAminoType extends AminoMsg {
  type: "/prism.incentives.MsgClaimReward";
  value: {
    creator: string;
    bond_denom: string;
    treasury: string;
...
export interface MsgClaimUnbondingAminoType extends AminoMsg {
  type: "/prism.incentives.MsgClaimUnbonding";
  value: {
    creator: string;
    unbonding_id: string;
  };
...
export interface MsgCancelUnbondingAminoType extends AminoMsg {
  type: "/prism.incentives.MsgCancelUnbonding";
  value: {
    creator: string;
    unbonding_id: string;
    amount: {
...
export interface MsgIncentivizePoolAminoType extends AminoMsg {
  type: "/prism.incentives.MsgIncentivizePool";
  value: {
    creator: string;
    bond_denom: string;
    amount: {
...
export const AminoConverter = {
  "/prism.incentives.MsgUpdateParams": {
    aminoType: "/prism.incentives.MsgUpdateParams",
    toAmino: ({
      authority,
      params
  ...
  "/prism.incentives.MsgCreatePool": {
    aminoType: "/prism.incentives.MsgCreatePool",
    toAmino: ({
      authority,
      bondDenom,
      rewardTokens
  ...
  "/prism.incentives.MsgUpdateRewardTokenWeight": {
    aminoType: "/prism.incentives.MsgUpdateRewardTokenWeight",
    toAmino: ({
      authority,
      bondDenom,
      rewardToken
  ...
  "/prism.incentives.MsgAddRewardTokenToPool": {
    aminoType: "/prism.incentives.MsgAddRewardTokenToPool",
    toAmino: ({
      authority,
      bondDenom,
      rewardToken
  ...
  "/prism.incentives.MsgBond": {
    aminoType: "/prism.incentives.MsgBond",
    toAmino: ({
      creator,
      amount
  ...
  "/prism.incentives.MsgUnbond": {
    aminoType: "/prism.incentives.MsgUnbond",
    toAmino: ({
      creator,
      amount,
      unbondTreasury,
  ...
  "/prism.incentives.MsgClaimReward": {
    aminoType: "/prism.incentives.MsgClaimReward",
    toAmino: ({
      creator,
      bondDenom,
      treasury
  ...
  "/prism.incentives.MsgClaimUnbonding": {
    aminoType: "/prism.incentives.MsgClaimUnbonding",
    toAmino: ({
      creator,
      unbondingId
  ...
  "/prism.incentives.MsgCancelUnbonding": {
    aminoType: "/prism.incentives.MsgCancelUnbonding",
    toAmino: ({
      creator,
      unbondingId,
      amount
  ...
  "/prism.incentives.MsgIncentivizePool": {
    aminoType: "/prism.incentives.MsgIncentivizePool",
    toAmino: ({
      creator,
      bondDenom,
      amount
