...
export class LCDQueryClient {
  ...
  async params(_params: QueryParamsRequest = {}): Promise<QueryParamsResponseSDKType> {
    const endpoint = `prism-finance/prism-core/incentives/params`;
    return await this.req.get<QueryParamsResponseSDKType>(endpoint);
  }
  /* Queries a Pool by index. */
  async pool(params: QueryGetPoolRequest): Promise<QueryGetPoolResponseSDKType> {
    const endpoint = `prism-finance/prism-core/incentives/pool/${params.bondDenom}`;
  ...
  async poolAll(params: QueryAllPoolRequest = {
    ...
    const endpoint = `prism-finance/prism-core/incentives/pool`;
  ...
  async bond(params: QueryGetBondRequest): Promise<QueryGetBondResponseSDKType> {
    const endpoint = `prism-finance/prism-core/incentives/bond/${params.address}/${params.bondDenom}`;
  ...
  async bondAll(params: QueryAllBondRequest = {
    ...
    const endpoint = `prism-finance/prism-core/incentives/bond`;
  ...
  async unbonding(params: QueryGetUnbondingRequest): Promise<QueryGetUnbondingResponseSDKType> {
    const endpoint = `prism-finance/prism-core/incentives/unbonding/${params.id}`;
  ...
  async unbondingAll(params: QueryAllUnbondingRequest = {
    ...
    const endpoint = `prism-finance/prism-core/incentives/unbonding`;
