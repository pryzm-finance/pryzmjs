...
import * as _296 from "./alliance/tx.amino";
import * as _297 from "./alliance/tx.registry";
import * as _298 from "./alliance/query.lcd";
import * as _299 from "./alliance/query.rpc.Query";
import * as _300 from "./alliance/tx.rpc.msg";
