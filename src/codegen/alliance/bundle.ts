...
import * as _304 from "./alliance/tx.amino";
import * as _305 from "./alliance/tx.registry";
import * as _306 from "./alliance/query.lcd";
import * as _307 from "./alliance/query.rpc.Query";
import * as _308 from "./alliance/tx.rpc.msg";
