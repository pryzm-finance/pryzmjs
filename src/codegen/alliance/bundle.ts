...
import * as _336 from "./alliance/tx.amino";
import * as _337 from "./alliance/tx.registry";
import * as _338 from "./alliance/query.lcd";
import * as _339 from "./alliance/query.rpc.Query";
import * as _340 from "./alliance/tx.rpc.msg";
