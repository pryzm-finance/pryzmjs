import { PoolOperationType, PoolTradeHistory, PoolTradeHistorySDKType, poolOperationTypeFromJSON, poolOperationTypeToJSON } from "../pool_trade_history";
...
export const QueryPoolTradeHistoryRequest = {
  ...
  fromJSON(object: any): QueryPoolTradeHistoryRequest {
    return {
      ...
      operationType: isSet(object.operationType) ? poolOperationTypeFromJSON(object.operationType) : 0
    };
  },
