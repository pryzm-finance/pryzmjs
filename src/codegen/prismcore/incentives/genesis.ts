...
export const GenesisState = {
  encode(message: GenesisState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.autoUnbondingList) {
      writer.uint64(v);
    }
    writer.ldelim();
    return writer;
        ...
        case 6:
          if ((tag & 7) === 2) {
            ...
            while (reader.pos < end2) {
              message.autoUnbondingList.push((reader.uint64() as Long));
            }
          } else {
            message.autoUnbondingList.push((reader.uint64() as Long));
          }
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      autoUnbondingList: Array.isArray(object?.autoUnbondingList) ? object.autoUnbondingList.map((e: any) => Long.fromValue(e)) : []
    };
  },
  toJSON(message: GenesisState): unknown {
    ...
    if (message.autoUnbondingList) {
      obj.autoUnbondingList = message.autoUnbondingList.map(e => (e || Long.UZERO).toString());
    } else {
      obj.autoUnbondingList = [];
    }
    return obj;
  },
  fromPartial(object: Partial<GenesisState>): GenesisState {
    ...
    message.autoUnbondingList = object.autoUnbondingList?.map(e => Long.fromValue(e)) || [];
    return message;
  }
};