...
export class QueryClientImpl implements Query {
  ...
  params(request: QueryParamsRequest = {}): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("prismfinance.prismcore.incentives.Query", "Params", data);
    return promise.then(data => QueryParamsResponse.decode(new _m0.Reader(data)));
  }
  pool(request: QueryGetPoolRequest): Promise<QueryGetPoolResponse> {
    const data = QueryGetPoolRequest.encode(request).finish();
    const promise = this.rpc.request("prismfinance.prismcore.incentives.Query", "Pool", data);
  ...
  poolAll(request: QueryAllPoolRequest = {
    ...
    const promise = this.rpc.request("prismfinance.prismcore.incentives.Query", "PoolAll", data);
  ...
  bond(request: QueryGetBondRequest): Promise<QueryGetBondResponse> {
    ...
    const promise = this.rpc.request("prismfinance.prismcore.incentives.Query", "Bond", data);
  ...
  bondAll(request: QueryAllBondRequest = {
    ...
    const promise = this.rpc.request("prismfinance.prismcore.incentives.Query", "BondAll", data);
  ...
  unbonding(request: QueryGetUnbondingRequest): Promise<QueryGetUnbondingResponse> {
    ...
    const promise = this.rpc.request("prismfinance.prismcore.incentives.Query", "Unbonding", data);
  ...
  unbondingAll(request: QueryAllUnbondingRequest = {
    ...
    const promise = this.rpc.request("prismfinance.prismcore.incentives.Query", "UnbondingAll", data);
