...
export class LCDQueryClient {
  ...
  async params(_params: QueryParamsRequest = {}): Promise<QueryParamsResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/params`;
  ...
  async poolToken(params: QueryGetPoolTokenRequest): Promise<QueryGetPoolTokenResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/pool_token/${params.poolId}/${params.denom}`;
  ...
  async pool(params: QueryGetPoolRequest): Promise<QueryGetPoolResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/pool/${params.id}`;
  ...
  async poolAll(params: QueryAllPoolRequest = {
    ...
    const endpoint = `prism-finance/prism-core/amm/pool`;
  ...
  async weightedToken(params: QueryGetWeightedTokenRequest): Promise<QueryGetWeightedTokenResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/weighted_token/${params.poolId}/${params.denom}`;
  ...
  async weightedTokenAll(params: QueryAllWeightedTokenRequest = {
    ...
    const endpoint = `prism-finance/prism-core/amm/weighted_token`;
  ...
  async weightUpdateTiming(params: QueryGetWeightUpdateTimingRequest): Promise<QueryGetWeightUpdateTimingResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/weight_update_timing/${params.poolId}`;
  ...
  async weightUpdateTimingAll(params: QueryAllWeightUpdateTimingRequest = {
    ...
    const endpoint = `prism-finance/prism-core/amm/weight_update_timing`;
  ...
  async simulateSingleSwap(params: QuerySimulateSingleSwapRequest, options: any = {params: {}}): Promise<QuerySimulateSingleSwapResponseSDKType> {
    ...
    const endpoint = `prism-finance/prism-core/amm/simulate_single_swap`;
  ...
  async simulateInitializePool(params: QuerySimulateInitializePoolRequest, options: any = {params: {}}): Promise<QuerySimulateInitializePoolResponseSDKType> {
    ...
    const endpoint = `prism-finance/prism-core/amm/simulate_initialize_pool/${params.poolId}`;
  ...
  async simulateJoinAllTokensExactLpt(params: QuerySimulateJoinAllTokensExactLptRequest, options: any = {params: {}}): Promise<QuerySimulateJoinAllTokensExactLptResponseSDKType> {
    ...
    const endpoint = `prism-finance/prism-core/amm/simulate_join_all_tokens_exact_lpt/${params.poolId}`;
  ...
  async simulateJoinExactTokens(params: QuerySimulateJoinExactTokensRequest, options: any = {params: {}}): Promise<QuerySimulateJoinExactTokensResponseSDKType> {
    ...
    const endpoint = `prism-finance/prism-core/amm/simulate_join_exact_tokens/${params.poolId}`;
  ...
  async simulateJoinTokenExactLpt(params: QuerySimulateJoinTokenExactLptRequest, options: any = {params: {}}): Promise<QuerySimulateJoinTokenExactLptResponseSDKType> {
    ...
    const endpoint = `prism-finance/prism-core/amm/simulate_join_token_exact_lpt/${params.poolId}`;
  ...
  async simulateExitTokenExactLpt(params: QuerySimulateExitTokenExactLptRequest, options: any = {params: {}}): Promise<QuerySimulateExitTokenExactLptResponseSDKType> {
    ...
    const endpoint = `prism-finance/prism-core/amm/simulate_exit_token_exact_lpt/${params.poolId}`;
  ...
  async simulateExitExactTokens(params: QuerySimulateExitExactTokensRequest, options: any = {params: {}}): Promise<QuerySimulateExitExactTokensResponseSDKType> {
    ...
    const endpoint = `prism-finance/prism-core/amm/simulate_exit_exact_tokens/${params.poolId}`;
  ...
  async simulateExitAllTokensExactLpt(params: QuerySimulateExitAllTokensExactLptRequest, options: any = {params: {}}): Promise<QuerySimulateExitAllTokensExactLptResponseSDKType> {
    ...
    const endpoint = `prism-finance/prism-core/amm/simulate_exit_all_tokens_exact_lpt/${params.poolId}`;
  ...
  async introducingPoolToken(params: QueryGetIntroducingPoolTokenRequest): Promise<QueryGetIntroducingPoolTokenResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/introducing_pool_token/${params.poolId}/${params.denom}`;
  ...
  async introducingPoolTokenAll(params: QueryAllIntroducingPoolTokenRequest = {
    ...
    const endpoint = `prism-finance/prism-core/amm/introducing_pool_token`;
  ...
  async expiringPoolToken(params: QueryGetExpiringPoolTokenRequest): Promise<QueryGetExpiringPoolTokenResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/expiring_pool_token/${params.poolId}/${params.denom}`;
  ...
  async expiringPoolTokenAll(params: QueryAllExpiringPoolTokenRequest = {
    ...
    const endpoint = `prism-finance/prism-core/amm/expiring_pool_token`;
  ...
  async lpToken(params: QueryLpTokenRequest): Promise<QueryLpTokenResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/lp_token/${params.poolId}`;
  ...
  async simulateBatchSwap(params: QuerySimulateBatchSwapRequest, options: any = {params: {}}): Promise<QuerySimulateBatchSwapResponseSDKType> {
    ...
    const endpoint = `prism-finance/prism-core/amm/simulate_batch_swap`;
  ...
  async yammConfiguration(params: QueryGetYammConfigurationRequest): Promise<QueryGetYammConfigurationResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/yamm_configuration/${params.poolId}`;
  ...
  async yammConfigurationAll(params: QueryAllYammConfigurationRequest = {
    ...
    const endpoint = `prism-finance/prism-core/amm/yamm_configuration`;
  ...
  async whitelistedRoute(params: QueryGetWhitelistedRouteRequest): Promise<QueryGetWhitelistedRouteResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/whitelisted_route/${params.tokenIn}/${params.tokenOut}`;
  ...
  async whitelistedRouteAll(params: QueryAllWhitelistedRouteRequest = {
    ...
    const endpoint = `prism-finance/prism-core/amm/whitelisted_route`;
  ...
  async order(params: QueryGetOrderRequest): Promise<QueryGetOrderResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/order/${params.id}`;
  ...
  async orderAll(params: QueryAllOrderRequest = {
    ...
    const endpoint = `prism-finance/prism-core/amm/order`;
  ...
  async executableOrder(params: QueryGetExecutableOrderRequest): Promise<QueryGetExecutableOrderResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/executable_order/${params.orderId}`;
  ...
  async executableOrderAll(params: QueryAllExecutableOrderRequest = {
    ...
    const endpoint = `prism-finance/prism-core/amm/executable_order`;
  ...
  async scheduleOrder(params: QueryGetScheduleOrderRequest): Promise<QueryGetScheduleOrderResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/schedule_order/${params.orderId}`;
  ...
  async scheduleOrderAll(params: QueryAllScheduleOrderRequest = {
    ...
    const endpoint = `prism-finance/prism-core/amm/schedule_order`;
  ...
  async oraclePricePair(params: QueryGetOraclePricePairRequest): Promise<QueryGetOraclePricePairResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/oracle_price_pair/${params.assetId}`;
  ...
  async oraclePricePairAll(params: QueryAllOraclePricePairRequest = {
    ...
    const endpoint = `prism-finance/prism-core/amm/oracle_price_pair`;
  ...
  async vaultPauseMode(_params: QueryVaultPauseModeRequest = {}): Promise<QueryVaultPauseModeResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/vault_pause_mode`;
  ...
  async pendingTokenIntroduction(params: QueryGetPendingTokenIntroductionRequest): Promise<QueryGetPendingTokenIntroductionResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/pending_token_introduction/${params.assetId}/${params.targetPoolId}`;
  ...
  async pendingTokenIntroductionAll(params: QueryAllPendingTokenIntroductionRequest = {
    ...
    const endpoint = `prism-finance/prism-core/amm/pending_token_introduction`;
  ...
  async yammPoolId(params: QueryYammPoolIdRequest): Promise<QueryYammPoolIdResponseSDKType> {
    const endpoint = `prism-finance/prism-core/amm/yamm_pool_id/${params.assetId}`;
