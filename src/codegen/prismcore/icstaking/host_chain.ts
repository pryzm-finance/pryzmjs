...
export interface HostChainState {
   ...
   */
  lastIdleStateHostHeight?: HostChainHeight;
}
/** A subset of state on the host chain needed by Prism */
export interface HostChainStateSDKType {
  ...
  state: State;
  last_idle_state_host_height?: HostChainHeightSDKType;
}
...
export const HostChainState = {
  ...
  fromJSON(object: any): HostChainState {
    return {
      ...
      lastIdleStateHostHeight: isSet(object.lastIdleStateHostHeight) ? HostChainHeight.fromJSON(object.lastIdleStateHostHeight) : undefined
    };
  },
  toJSON(message: HostChainState): unknown {
    ...
    message.lastIdleStateHostHeight !== undefined && (obj.lastIdleStateHostHeight = message.lastIdleStateHostHeight ? HostChainHeight.toJSON(message.lastIdleStateHostHeight) : undefined);
    return obj;
  },
  fromPartial(object: Partial<HostChainState>): HostChainState {
    ...
    message.lastIdleStateHostHeight = object.lastIdleStateHostHeight !== undefined && object.lastIdleStateHostHeight !== null ? HostChainHeight.fromPartial(object.lastIdleStateHostHeight) : undefined;
    return message;
  }
};
