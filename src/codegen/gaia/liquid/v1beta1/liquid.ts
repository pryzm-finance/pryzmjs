...
export const Params = {
  ...
  toJSON(message: Params): unknown {
    const obj: any = {};
    message.globalLiquidStakingCap !== undefined && (obj.globalLiquidStakingCap = message.globalLiquidStakingCap);
    message.validatorLiquidStakingCap !== undefined && (obj.validatorLiquidStakingCap = message.validatorLiquidStakingCap);
    return obj;
  },
  ...
  toAmino(message: Params, useInterfaces: boolean = true): ParamsAmino {
    const obj: any = {};
    obj.global_liquid_staking_cap = padDecimal(message.globalLiquidStakingCap) === "" ? undefined : padDecimal(message.globalLiquidStakingCap);
    obj.validator_liquid_staking_cap = padDecimal(message.validatorLiquidStakingCap) === "" ? undefined : padDecimal(message.validatorLiquidStakingCap);
    return obj;
  },
...
export const TokenizeShareRecord = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = true): TokenizeShareRecord {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: TokenizeShareRecord, useInterfaces: boolean = true): TokenizeShareRecordAmino {
    const obj: any = {};
  ...
  fromProtoMsg(message: TokenizeShareRecordProtoMsg, useInterfaces: boolean = true): TokenizeShareRecord {
    return TokenizeShareRecord.decode(message.value, undefined, useInterfaces);
  },
...
export const PendingTokenizeShareAuthorizations = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = true): PendingTokenizeShareAuthorizations {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: PendingTokenizeShareAuthorizations, useInterfaces: boolean = true): PendingTokenizeShareAuthorizationsAmino {
    const obj: any = {};
    if (message.addresses) {
      obj.addresses = message.addresses.map(e => e);
    } else {
  ...
  fromProtoMsg(message: PendingTokenizeShareAuthorizationsProtoMsg, useInterfaces: boolean = true): PendingTokenizeShareAuthorizations {
    return PendingTokenizeShareAuthorizations.decode(message.value, undefined, useInterfaces);
  },
...
export const TokenizeShareRecordReward = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = true): TokenizeShareRecordReward {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: TokenizeShareRecordReward, useInterfaces: boolean = true): TokenizeShareRecordRewardAmino {
    const obj: any = {};
  ...
  fromProtoMsg(message: TokenizeShareRecordRewardProtoMsg, useInterfaces: boolean = true): TokenizeShareRecordReward {
    return TokenizeShareRecordReward.decode(message.value, undefined, useInterfaces);
  },
...
export const LiquidValidator = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = true): LiquidValidator {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: LiquidValidator, useInterfaces: boolean = true): LiquidValidatorAmino {
    const obj: any = {};
    obj.operator_address = message.operatorAddress === "" ? undefined : message.operatorAddress;
    obj.liquid_shares = padDecimal(message.liquidShares) === "" ? undefined : padDecimal(message.liquidShares);
    return obj;
  },
  fromAminoMsg(object: LiquidValidatorAminoMsg): LiquidValidator {
    return LiquidValidator.fromAmino(object.value);
  },
  fromProtoMsg(message: LiquidValidatorProtoMsg, useInterfaces: boolean = true): LiquidValidator {
