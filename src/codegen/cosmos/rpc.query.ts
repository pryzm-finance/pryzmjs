...
export const createGrpcWebClient = async ({
  ...
  return {
    cosmos: {
      ...
      autocli: {
        v1: new (await import("./autocli/v1/query.rpc.Query")).QueryClientImpl(grpcWeb)
      },
      bank: {
      ...
      base: {
        node: {
          v1beta1: new (await import("./base/node/v1beta1/query.rpc.Service")).ServiceClientImpl(grpcWeb)
        },
        tendermint: {
      ...
      consensus: {
        v1: new (await import("./consensus/v1/query.rpc.Query")).QueryClientImpl(grpcWeb)
      },
      distribution: {
      ...
      orm: {
        query: {
          v1alpha1: new (await import("./orm/query/v1alpha1/query.rpc.Query")).QueryClientImpl(grpcWeb)
        }
      },
      params: {
