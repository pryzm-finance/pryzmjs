...
export const createRPCMsgClient = async ({
  ...
  return {
    cosmos: {
      auth: {
        v1beta1: new (await import("./auth/v1beta1/tx.rpc.msg")).MsgClientImpl(grpcWeb)
      },
      authz: {
      ...
      consensus: {
        v1: new (await import("./consensus/v1/tx.rpc.msg")).MsgClientImpl(grpcWeb)
      },
      crisis: {
      ...
      mint: {
        v1beta1: new (await import("./mint/v1beta1/tx.rpc.msg")).MsgClientImpl(grpcWeb)
      },
      nft: {
