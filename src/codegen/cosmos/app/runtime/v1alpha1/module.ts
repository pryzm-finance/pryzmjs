    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          message.overrideStoreKeys.push(StoreKeyConfig.decode(reader, reader.uint32(), useInterfaces));
          break;
        default:
...
export const StoreKeyConfig = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = true): StoreKeyConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: StoreKeyConfig, useInterfaces: boolean = true): StoreKeyConfigAmino {
    const obj: any = {};
  ...
  toAminoMsg(message: StoreKeyConfig, useInterfaces: boolean = true): StoreKeyConfigAminoMsg {
    return {
      type: "cosmos-sdk/StoreKeyConfig",
      value: StoreKeyConfig.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: StoreKeyConfigProtoMsg, useInterfaces: boolean = true): StoreKeyConfig {
    return StoreKeyConfig.decode(message.value, undefined, useInterfaces);
  },
