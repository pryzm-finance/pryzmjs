...
export const Module = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = true): Module {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.maxExecutionPeriod = Duration.decode(reader, reader.uint32(), useInterfaces);
          break;
        case 2:
  ...
  toAmino(message: Module, useInterfaces: boolean = true): ModuleAmino {
    const obj: any = {};
    obj.max_execution_period = message.maxExecutionPeriod ? Duration.toAmino(message.maxExecutionPeriod, useInterfaces) : undefined;
