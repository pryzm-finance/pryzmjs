...
function createBaseWhitelistedRoute(): WhitelistedRoute {
  return { steps: [], enabled: false };
}

export const WhitelistedRoute = {
  encode(message: WhitelistedRoute, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WhitelistedRoute {
  ...
  fromPartial<I extends Exact<DeepPartial<WhitelistedRoute>, I>>(object: I): WhitelistedRoute {
    const message = createBaseWhitelistedRoute();
